...
import { CheckInData, Reservation } from '../types.ts';
import * as googleScriptService from '../services/googleScriptService.ts';
import { validateStudentId, parseTimeRange } from '../utils/helpers.ts';
